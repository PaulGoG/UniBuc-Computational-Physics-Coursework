...
Plot = Grafic_scatter(dn.E, dn.N, dn.σN, :black, "Date experimentale în SL - Gook", Plot);
...
Plot = Grafic_scatter(dn_normat.E, dn_normat.N, dn_normat.σN, :black, "Date experimentale în SL - Gook", Plot);
Plot = Grafic_textbox(5.7, 0.09, latexstring("\$\\chi^2\$ = $(round(χ_sq, digits = 3)), \$\\mathrm{T_M}\$ = $(round(T_M, digits = 3)) MeV"), Plot);
...
Plot = Grafic_scatter(dn.E, dn.N, dn.σN, :black, "Date experimentale în SL - Vorobyev", Plot);
Plot = Grafic_textbox(13.8, 0.28, latexstring("\$\\chi^2\$ = $(round(χ_sq, digits = 3)), \$\\mathrm{T_M}\$ = $(round(T_M, digits = 3)) MeV"), Plot);
...
Plot = Grafic_scatter(dn_normat.E, dn_normat.N, dn_normat.σN, :black, "Date experimentale în SL - Vorobyev", Plot);
...
Plot = Grafic_scatter(dn.E, dn.N, dn.σN, :black, "Date experimentale în SCM pentru LF - Gook ", Plot);
Plot = Grafic_textbox(5.25, 0.5, latexstring("\$\\chi^2\$ = $(round(χ_sq, digits = 3)), \$\\mathrm{T_M}\$ = $(round(T_M, digits = 3)) MeV"), Plot);
...
Plot = Grafic_scatter(dn_normat.E, dn_normat.N, dn_normat.σN, :black, "Date experimentale în SCM pentru LF - Gook", Plot);
Plot = Grafic_textbox(2.8, 3.65, latexstring("\$\\chi^2\$ = $(round(χ_sq, digits = 3)), \$\\mathrm{T_M}\$ = $(round(T_M, digits = 3)) MeV"), Plot);
...
Plot = Grafic_scatter(dn.E, dn.N, dn.σN, :black, "Date experimentale în SCM pentru HF - Gook", Plot);
Plot = Grafic_textbox(5.4, 0.38, latexstring("\$\\chi^2\$ = $(round(χ_sq, digits = 3)), \$\\mathrm{T_M}\$ = $(round(T_M, digits = 3)) MeV"), Plot);
...
Plot = Grafic_scatter(dn_normat.E, dn_normat.N, dn_normat.σN, :black, "Date experimentale în SCM pentru HF - Gook", Plot);
Plot = Grafic_textbox(3.2, 4.1, latexstring("\$\\chi^2\$ = $(round(χ_sq, digits = 3)), \$\\mathrm{T_M}\$ = $(round(T_M, digits = 3)) MeV"), Plot);
